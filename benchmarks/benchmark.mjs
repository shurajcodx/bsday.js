...
results.push(
  runBenchmark('BS ➔ AD Conversion (bsday.bs)', (i) => {
    const y = 2000 + (i % 80);
    const m = 1 + (i % 12);
    const d = 1 + (i % 28);
...
results.push(
  runBenchmark('AD ➔ BS Conversion (bsday.fromAD)', (i) => {
...
results.push(
  runBenchmark('Date Formatting (format)', () => {
...
results.push(
  runBenchmark('Date Arithmetic (add 7 days & startOf)', (i) => {
...
results.push(
  runBenchmark('Fiscal Year Calculation (fiscalYear)', () => {
...
results.push(
  runBenchmark('KYC Age Calculation (age + formatAge)', () => {
...
results.push(
  runBenchmark('Calendar Matrix Grid (42 cells)', (i) => {
